/* * * * * * * * * * * * * 
 * TriScinti_Ref1ToF.hh        *
 *                       *
 *	T. Fujiwara          *
 *	2020. 07. 24 (Fri)   *
 * * * * * * * * * * * * */
#ifndef TriScinti_Ref1ToF_h
#define TriScinti_Ref1ToF_h 1
...
int const ChID[3] = {0, 2, 3};	//Ref-1, ToF-1, ToF-2
...
class TriScinti_Ref1ToF
{
	...
	private:
		...
		TH2D *h_2D_DecTQ[3];
		TH2D *h_2D_CutTQ[3];
		TH2D *h_2D_Factor[3];			//0: ToF-1 vs. ToF-2, 1: Ref-1 vs. ToF-1, 2: Ref-1 vs. ToF-2
		...
		TString Ref_TwlkType;

		double TwlkFitMax[NofMPPC];
		double TwlkFitMin[NofMPPC];
		double TwlkPar_In[3][5];
		double TwlkPar_Val[3][5];
		double TwlkPar_Err[3][5];
		double TwlkFactor[3];
