...
#include "../Setting.h"
#include "./DoubleScinti_Ref2ToF.hh"

////////////////////////////////////////////////////////////////////////////////////
////////////////////////////////////////////////////////////////////////////////////
////////////////////////////////////////////////////////////////////////////////////
DoubleScinti_Ref2ToF::DoubleScinti_Ref2ToF(){
	cout<<"DoubleScinti_Ref2ToF::Constructer called"<<endl;
...
////////////////////////////////////////////////////////////////////////////////////
DoubleScinti_Ref2ToF::~DoubleScinti_Ref2ToF(){
	cout<<"DoubleScinti_Ref2ToF::Destructer called"<<endl;
	cout<<"See you!!!"<<endl;
}	

////////////////////////////////////////////////////////////////////////////////////
////////////////////////////////////////////////////////////////////////////////////
double DoubleScinti_Ref2ToF::Twlk_Correction( double x, double* parameter, double Coeff ){
	double Twlk_func=0.;
...
////////////////////////////////////////////////////////////////////////////////////
double DoubleScinti_Ref2ToF::Twlk_Correction_ToF( double x, double* parameter, double Coeff, int Mode ){
	double Twlk_func=0.;
...
////////////////////////////////////////////////////////////////////////////////////
void DoubleScinti_Ref2ToF::TwlkMan(int Type){
	if(ReadFlag){
		cout<<"Twlk type: set by import file"<<endl;
	}else{
		TwlkMode=Type;
		cout<<"Twlk type set by key input"<<endl;
	};
...
////////////////////////////////////////////////////////////////////////////////////
void DoubleScinti_Ref2ToF::SetRoot( int RNum ){
	RunNum = RNum;
...
////////////////////////////////////////////////////////////////////////////////////
void DoubleScinti_Ref2ToF::ImportPedestal( int PNum ){
	int i=0;
	double Val1, Val2;	
	...
	if(!ifs){
		cout<<"There is no such file: "<<Param_Ped<<endl;
		return;
	}else;
...
////////////////////////////////////////////////////////////////////////////////////
void DoubleScinti_Ref2ToF::DefineCanv(){
	cout<<"=====   DoubleScinti_Ref2ToF::DefineCanv ====="<<endl;
...
////////////////////////////////////////////////////////////////////////////////////
void DoubleScinti_Ref2ToF::DefineHistFunc(){
	cout<<"=====   DoubleScinti_Ref2ToF::DefineHistFunc ====="<<endl;
	...
	Set -> Setting_Hist2D( h_2D_Factor[0], "Factor tuning: ToF-1 vs. ToF-2", "ToF-1 Factor", "ToF-2 Factor", "#sigma_{Ref2ToF} [psec]", 1.);
	Set -> Setting_Hist2D( h_2D_Factor[1], "Factor tuning: Ref-2 vs. ToF-1", "Ref-2 Factor", "ToF-1 Factor", "#sigma_{Ref2ToF} [psec]", 1.);
	Set -> Setting_Hist2D( h_2D_Factor[2], "Factor tuning: Ref-2 vs. ToF-2", "Ref-2 Factor", "ToF-2 Factor", "#sigma_{Ref2ToF} [psec]", 1.);
	...
	h_1D_DecToF = new TH1D( "h_1D_DecToF", "h_1D_DecToF", 140, -2800., 2800. );
...
////////////////////////////////////////////////////////////////////////////////////
void DoubleScinti_Ref2ToF::FillHist(){
	cout<<"=====   DoubleScinti_Ref2ToF::FillHist   ====="<<endl;
...
////////////////////////////////////////////////////////////////////////////////////
void DoubleScinti_Ref2ToF::GetQDCCut(){
	cout<<"=====   DoubleScinti_Ref2ToF::GetQDCCut   ====="<<endl;
	for(int i=0; i<3; i++){
	...
	QCut[0][0] = 100.;
	QCut[0][1] = 250.;
//	TwlkFitMin[2] = 50.;		//For run096(To fit linear)
//	TwlkFitMax[2] = 105.;
	TwlkFitMin[1] = 10.;
	TwlkFitMax[1] = 250.;

	if(RunNum==148){
		TwlkFitMin[3] = 8.;		//2020. 08. 27 目で見て決めた。
		TwlkFitMax[3] = 21.;	//2020. 08. 27 目で見て決めた。上に同じ.
	}else;
...
////////////////////////////////////////////////////////////////////////////////////
void DoubleScinti_Ref2ToF::TwlkFit(){
	cout<<"=====   DoubleScinti_Ref2ToF::TwlkFit   ====="<<endl;
...
////////////////////////////////////////////////////////////////////////////////////
void DoubleScinti_Ref2ToF::TwlkSerchBestFactorToF1vsToF2(){
	cout<<"=====   DoubleScinti_Ref2ToF::TwlkSerchBestFactorToF1vsToF2   ====="<<endl;
	TwlkFactor[0] = 1.000;
	TwlkFactor[1] = 0.625;
	TwlkFactor[2] = 0.700;
...
////////////////////////////////////////////////////////////////////////////////////
void DoubleScinti_Ref2ToF::TwlkSerchBestFactorRef2vsToF1(){
	cout<<"=====   DoubleScinti_Ref2ToF::TwlkSerchBestFactorRef2vsToF1   ====="<<endl;
	...
	//	for(int j=0; j<41; j++){
		...
		//	h_1D_DecToF_tmp = new TH1D( "h_1D_DecToF_tmp", "h_1D_DecToF_tmp", 320, -8400., 2800. );
			...
			if( Twlk_SigVal_tmp<Twlk_SigVal_Best[1] ){
				...
				Twlk_FactorBestSigma[0] = TwlkFactor[0];
				Twlk_FactorBestSigma[1] = TwlkFactor[1];
				cout<<"Preriminary factor Ref-2 and ToF-1 >> "<<Twlk_FactorBestSigma[0]<<",  "<<Twlk_FactorBestSigma[1]<<":  "<<"Sigma_TOF = "<<Twlk_SigVal_Best[1]<<" psec"<<endl;
			}else;
...
////////////////////////////////////////////////////////////////////////////////////
void DoubleScinti_Ref2ToF::TwlkSerchBestFactorRef2vsToF2(){
	cout<<"=====   DoubleScinti_Ref2ToF::TwlkSerchBestFactorRef2vsToF2   ====="<<endl;
	for(int i=0; i<FactorSearchMax[0]; i++){
		for(int j=0; j<FactorSearchMax[2]; j++){
			TwlkFactor[0] = 0.000+0.025*i;
			TwlkFactor[2] = 0.000+0.025*j;
...
////////////////////////////////////////////////////////////////////////////////////
void DoubleScinti_Ref2ToF::TwlkDecToF(){
	cout<<"=====   DoubleScinti_Ref2ToF::TwlkDecToF   ====="<<endl;
	...
	for(int i=0; i<Entry; i++){
		...
		if(
			...
			&& TDC[3]>TDCcut[3][0]
			&& TDC[3]<TDCcut[3][1]
		//	&& 0.1*QDC[ChID[0]]>50.+0.1*Pede_Cnt_Val[ChID[0]]
			&& 0.1*QDC[ChID[0]]>QCut[0][0]
			&& 0.1*QDC[ChID[1]]>QCut[1][0]
			&& 0.1*QDC[ChID[2]]>QCut[2][0]
		){
	...
	for(int i=0; i<5; i++){
		...
		h_1D_DecToF->Fit( f_dTof, "", "", par_tmp2-1400., par_tmp2+1400. );
	}
	...
	gPad->Update();
	DecTOFStat = (TPaveStats*)h_1D_DecToF->FindObject("stats");
	DecTOFStat -> SetX1NDC(.775);
	DecTOFStat -> SetX2NDC(.975);
	DecTOFStat -> SetY1NDC(.775);
	DecTOFStat -> SetY2NDC(.975);
	Ca[5]->Modified();
	
}

////////////////////////////////////////////////////////////////////////////////////
void DoubleScinti_Ref2ToF::DrawHist(){
	cout<<"=====   DoubleScinti_Ref2ToF::DrawHist   ====="<<endl;
...
////////////////////////////////////////////////////////////////////////////////////
void DoubleScinti_Ref2ToF::SaveHist( int NSave){
	cout<<"=====   DoubleScinti_Ref2ToF::SaveHist   ====="<<endl;
	if(NSave==0){
		NofSaveCanv = NofCanv;
...
//	figure       = Form("run%03d_DoubleScinti_Ref2ToF_%02d.pdf", RunNum, ItNum );
	figure       = Form("DoubleScintiAna/DoubleScinti_Ref2ToF_run%03d_%02d.pdf", RunNum, ItNum );
...
////////////////////////////////////////////////////////////////////////////////////
void DoubleScinti_Ref2ToF::ExportTwlk(){
	cout<<"=====   DoubleScinti_Ref2ToF::ExportTwlk   ====="<<endl;
	string ExParam = Form("paramDoubleScintiRef2ToF_run%03d_%02d.dat", RunNum, ItNum);
	...
	ofs<<"====="<<endl;
	ofs<<endl;
	ofs<<Form("Ref-2 Pedestal [ch] >> %.2lf", Pede_Cnt_Val[1])<<endl;
	...
	ofs<<Form("Ref-2 FitMax >> %.2lf", TwlkFitMax[1])<<endl;
	ofs<<Form("ToF-1 FitMax >> %.2lf", TwlkFitMax[2])<<endl;
	ofs<<Form("ToF-2 FitMax >> %.2lf", TwlkFitMax[3])<<endl;
	ofs<<"====="<<endl;
	ofs<<endl;
	ofs<<"====="<<endl;
	ofs<<"Time walk correction functional type >> "<<TwlkMode<<": "<<ToF_TwlkType<<endl;
	ofs<<endl;
...
////////////////////////////////////////////////////////////////////////////////////
void DoubleScinti_Ref2ToF::ReadTwlk(int R, int I){
	Param_Read = Form("TESTparamDoubleScintiRef2ToF_run%03d_%02d.dat", R, I );
	Param_Read = PATH_param_t+Param_Read;

	ifstream ifs( Param_Read.c_str(), ios_base::in );
	if(!ifs){
	...
	ifs>>TwlkMode;					cout<<TwlkMode<<endl;
	ifs>>FactorSearchMax[0];		cout<<FactorSearchMax[0]<<endl;
	ifs>>FactorSearchMax[1];		cout<<FactorSearchMax[1]<<endl;
	ifs>>FactorSearchMax[2];		cout<<FactorSearchMax[2]<<endl;
	ifs>>TwlkFitMax[0];				cout<<TwlkFitMax[0]<<endl;
	ifs>>TwlkFitMax[1];				cout<<TwlkFitMax[1]<<endl;
	ifs>>TwlkFitMax[2];				cout<<TwlkFitMax[2]<<endl;
	ifs>>TwlkFitMax[3];				cout<<TwlkFitMax[3]<<endl;
	ifs>>TwlkFitMin[0];				cout<<TwlkFitMin[0]<<endl;
	ifs>>TwlkFitMin[1];				cout<<TwlkFitMin[1]<<endl;
	ifs>>TwlkFitMin[2];				cout<<TwlkFitMin[2]<<endl;
	ifs>>TwlkFitMin[3];				cout<<TwlkFitMin[3]<<endl;

	ifs>>QDCBin[0];					cout<<QDCBin[0]<<endl;
	ifs>>QDCBin[1];					cout<<QDCBin[1]<<endl;
	ifs>>QDCBin[2];					cout<<QDCBin[2]<<endl;
	ifs>>QDCMax[0];					cout<<QDCMax[0]<<endl;
	ifs>>QDCMax[1];					cout<<QDCMax[1]<<endl;
	ifs>>QDCMax[2];					cout<<QDCMax[2]<<endl;

	ifs>>Twlk_FactorBestSigma[0];	cout<<Twlk_FactorBestSigma[0]<<endl;
	ifs>>Twlk_FactorBestSigma[1];	cout<<Twlk_FactorBestSigma[1]<<endl;
	ifs>>Twlk_FactorBestSigma[2];	cout<<Twlk_FactorBestSigma[2]<<endl;

	ifs>>TwlkPar_Val[0][0];			cout<<TwlkPar_Val[0][0]<<endl;
	ifs>>TwlkPar_Val[0][1];			cout<<TwlkPar_Val[0][1]<<endl;
	ifs>>TwlkPar_Val[0][2];			cout<<TwlkPar_Val[0][2]<<endl;
	ifs>>TwlkPar_Val[0][3];			cout<<TwlkPar_Val[0][3]<<endl;
	ifs>>TwlkPar_Val[1][0];			cout<<TwlkPar_Val[1][0]<<endl;
	ifs>>TwlkPar_Val[1][1];			cout<<TwlkPar_Val[1][1]<<endl;
	ifs>>TwlkPar_Val[1][2];			cout<<TwlkPar_Val[1][2]<<endl;
	ifs>>TwlkPar_Val[1][3];			cout<<TwlkPar_Val[1][3]<<endl;
	ifs>>TwlkPar_Val[2][0];			cout<<TwlkPar_Val[2][0]<<endl;
	ifs>>TwlkPar_Val[2][1];			cout<<TwlkPar_Val[2][1]<<endl;
	ifs>>TwlkPar_Val[2][2];			cout<<TwlkPar_Val[2][2]<<endl;
	ifs>>TwlkPar_Val[2][3];			cout<<TwlkPar_Val[2][3]<<endl;

	ifs>>ToF_Adj;					cout<<ToF_Adj<<endl;
...
int main( int argc, char** argv ){
	...
	TApplication *theApp;
	DoubleScinti_Ref2ToF *analysis;

	theApp = new TApplication("App", &argc, argv );
	analysis = new DoubleScinti_Ref2ToF();
